...
class SideWidget extends StatefulWidget {
  const SideWidget({
    Key? key,
    int? indexNumber,
  })  : this.indexNumber = indexNumber ?? 0,
        super(key: key);
