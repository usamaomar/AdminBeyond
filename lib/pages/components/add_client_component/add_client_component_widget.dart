...
import 'add_client_component_model.dart';
export 'add_client_component_model.dart';

class AddClientComponentWidget extends StatefulWidget {
  const AddClientComponentWidget({Key? key}) : super(key: key);

  @override
  _AddClientComponentWidgetState createState() =>
      _AddClientComponentWidgetState();
}

class _AddClientComponentWidgetState extends State<AddClientComponentWidget> {
  late AddClientComponentModel _model;
                              ...
                              onPressed: () async {
                                if (_model.textController1.text != null &&
                                  ...
                                  _model.registerUserApiResult =
                                      await AddClientApiCall.call(
                                    name: _model.textController1.text,
                                    email: _model.textController2.text,
                                    phoneNumber: _model.textController3.text,
                                    address: _model.textController4.text,
                                    contactName: _model.textController5.text,
                                    alternativePhoneNumber:
                                        _model.textController6.text,
                                    token: FFAppState().userModel.token,
                                    logoImageUrl: _model.myUploadedImagePath,
                                  );
                                  if ((_model
