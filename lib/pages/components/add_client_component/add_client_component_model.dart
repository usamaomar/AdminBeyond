...
import 'add_client_component_widget.dart' show AddClientComponentWidget;
...
class AddClientComponentModel
    extends FlutterFlowModel<AddClientComponentWidget> {
  ...
  // Stores action output result for [Backend Call - API (AddClientApi)] action in Button widget.
